...
var $strongName = '3D947414FB75954BB278F77795059AEC';
var $gwt = {};
...
var $intern_0 = 6.283185307179586, $intern_1 = 3.141592653589793, $intern_2 = {3:1}, $intern_3 = {3:1, 4:1}, $intern_4 = {3:1, 5:1, 4:1}, $intern_5 = {66:1, 17:1, 3:1, 13:1, 20:1}, $intern_6 = {33:1, 3:1, 5:1, 4:1}, $intern_7 = {23:1, 3:1, 5:1, 4:1}, $intern_8 = 1000, $intern_9 = 65535, $intern_10 = 1900, $intern_11 = {3:1, 13:1, 8:1}, $intern_12 = -2147483648, $intern_13 = 4194303, $intern_14 = 1048575, $intern_15 = 524288, $intern_16 = 4194304, $intern_17 = 17592186044416, $intern_18 = -17592186044416, $intern_19 = 32768, $intern_20 = 65536, $intern_21 = {29:1, 24:1, 26:1, 25:1, 30:1, 16:1, 12:1}, $intern_22 = {29:1, 24:1, 26:1, 25:1, 30:1, 47:1, 16:1, 12:1}, $intern_23 = {37:1}, $intern_24 = {3:1, 18:1, 94:1}, $intern_25 = {3:1, 186:1};
...
defineClass(217, 1, {});
var instance;
var Lcom_google_gwt_animation_client_AnimationScheduler_2_classLit = createForClass('com.google.gwt.animation.client', 'AnimationScheduler', 217);
...
defineClass(168, 217, {}, AnimationSchedulerImplStandard);
...
function $updateAnimations(this$static){
  ...
  curAnimations = initUnidimensionalArray(Lcom_google_gwt_animation_client_AnimationSchedulerImplTimer$AnimationHandleImpl_2_classLit, {225:1, 3:1}, 60, this$static.animationRequests.array.length, 0, 1);
  curAnimations = castTo($toArray(this$static.animationRequests, curAnimations), 225);
...
defineClass(170, 217, {}, AnimationSchedulerImplTimer);
...
var escapeTable_0;
defineClass(187, 1, {});
var Lcom_google_gwt_core_client_Scheduler_2_classLit = createForClass('com.google.gwt.core.client', 'Scheduler', 187);
...
defineClass(149, 187, {}, SchedulerImpl);
...
defineClass(110, 202, {}, StackTraceCreator$CollectorLegacy);
...
defineClass(111, 203, {}, StackTraceCreator$CollectorModernNoSourceMap);
...
;
var Lcom_google_web_bindery_event_shared_Event_2_classLit = createForClass('com.google.web.bindery.event.shared', 'Event', 206);
...
defineClass(207, 206, {});
_.dead = false;
var Lcom_google_gwt_event_shared_GwtEvent_2_classLit = createForClass('com.google.gwt.event.shared', 'GwtEvent', 207);
...
defineClass(166, 207, {}, CloseEvent_0);
...
function $doFire(this$static, event_0){
  ...
  try {
    ...
    while (this$static.isReverseOrder?it.hasPrevious():it.hasNext_0()) {
      ...
      try {
        event_0.dispatch(castTo(handler, 223));
      }
       catch ($e0) {
        $e0 = toJava($e0);
        if (instanceOf($e0, 4)) {
  ...
  if (this$static.deferredDeltas) {
    try {
      for (c$iterator = new ArrayList$1(this$static.deferredDeltas); c$iterator.i < c$iterator.this$01.array.length;) {
        c = castTo($next_1(c$iterator), 224);
...
defineClass(176, 54, {}, Request$1);
_.run = function run_0(){
  $fireOnTimeout(this.this$01);
}
;
var Lcom_google_gwt_http_client_Request$1_2_classLit = createForClass('com.google.gwt.http.client', 'Request/1', 176);
defineClass(218, 1, {});
var Lcom_google_gwt_http_client_Response_2_classLit = createForClass('com.google.gwt.http.client', 'Response', 218);
defineClass(174, 218, {});
...
defineClass(175, 174, {}, Request$RequestImplIE8And9$1);
var Lcom_google_gwt_http_client_Request$RequestImplIE8And9$1_2_classLit = createForClass('com.google.gwt.http.client', 'Request/RequestImplIE8And9/1', 175);
...
defineClass(178, 23, $intern_7, RequestPermissionException);
var Lcom_google_gwt_http_client_RequestPermissionException_2_classLit = createForClass('com.google.gwt.http.client', 'RequestPermissionException', 178);
...
defineClass(181, 23, $intern_7, RequestTimeoutException);
var Lcom_google_gwt_http_client_RequestTimeoutException_2_classLit = createForClass('com.google.gwt.http.client', 'RequestTimeoutException', 181);
...
defineClass(180, 1, {});
var Lcom_google_gwt_i18n_shared_DateTimeFormat_2_classLit = createForClass('com.google.gwt.i18n.shared', 'DateTimeFormat', 180);
...
defineClass(63, 180, {63:1}, DateTimeFormat);
var cache;
var Lcom_google_gwt_i18n_client_DateTimeFormat_2_classLit = createForClass('com.google.gwt.i18n.client', 'DateTimeFormat', 63);
defineClass(221, 1, {});
var Lcom_google_gwt_i18n_shared_DefaultDateTimeFormatInfo_2_classLit = createForClass('com.google.gwt.i18n.shared', 'DefaultDateTimeFormatInfo', 221);
defineClass(222, 221, {});
var Lcom_google_gwt_i18n_client_DefaultDateTimeFormatInfo_2_classLit = createForClass('com.google.gwt.i18n.client', 'DefaultDateTimeFormatInfo', 222);
...
defineClass(185, 1, {}, TimeZone);
_.standardOffset = 0;
var Lcom_google_gwt_i18n_client_TimeZone_2_classLit = createForClass('com.google.gwt.i18n.client', 'TimeZone', 185);
function DateTimeFormatInfoImpl(){
}

defineClass(183, 222, {}, DateTimeFormatInfoImpl);
var Lcom_google_gwt_i18n_client_impl_cldr_DateTimeFormatInfoImpl_2_classLit = createForClass('com.google.gwt.i18n.client.impl.cldr', 'DateTimeFormatInfoImpl', 183);
...
defineClass(184, 8, $intern_11, DateRecord);
...
_.tzOffset = 0;
_.year = 0;
var Lcom_google_gwt_i18n_shared_impl_DateRecord_2_classLit = createForClass('com.google.gwt.i18n.shared.impl', 'DateRecord', 184);
defineClass(220, 1, {});
_.isObject = function isObject(){
  return null;
}
;
var Lcom_google_gwt_json_client_JSONValue_2_classLit = createForClass('com.google.gwt.json.client', 'JSONValue', 220);
function JSONArray(arr){
  this.jsArray = arr;
}

defineClass(61, 220, {61:1}, JSONArray);
...
defineClass(93, 220, {}, JSONBoolean);
...
defineClass(182, 220, {}, JSONNull);
_.toString_0 = function toString_9(){
  return 'null';
}
;
var instance_1;
var Lcom_google_gwt_json_client_JSONNull_2_classLit = createForClass('com.google.gwt.json.client', 'JSONNull', 182);
function JSONNumber(value_0){
  this.value_0 = value_0;
}

defineClass(49, 220, {49:1}, JSONNumber);
...
defineClass(62, 220, {62:1}, JSONObject);
...
defineClass(48, 220, {48:1}, JSONString);
...
defineClass(189, 1, {});
var Lcom_google_gwt_logging_client_LogConfiguration$LogConfigurationImplRegular_2_classLit = createForClass('com.google.gwt.logging.client', 'LogConfiguration/LogConfigurationImplRegular', 189);
function LogConfiguration$LogConfigurationImplSevere(){
}

defineClass(98, 189, {}, LogConfiguration$LogConfigurationImplSevere);
...
defineClass(215, 1, {});
var Ljava_util_logging_Formatter_2_classLit = createForClass('java.util.logging', 'Formatter', 215);
defineClass(216, 215, {});
var Lcom_google_gwt_logging_impl_FormatterImpl_2_classLit = createForClass('com.google.gwt.logging.impl', 'FormatterImpl', 216);
...
defineClass(92, 216, {}, TextLogFormatter);
...
defineClass(204, 1, {});
var Ljava_io_OutputStream_2_classLit = createForClass('java.io', 'OutputStream', 204);
function FilterOutputStream(out){
}

defineClass(74, 204, {}, FilterOutputStream);
...
defineClass(122, 207, {}, Window$ClosingEvent);
...
;
var Lcom_google_gwt_user_client_ui_Panel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'Panel', 205);
...
defineClass(52, 112, $intern_21, AbsolutePanel);
...
defineClass(46, 12, $intern_21, Image_0);
_.onBrowserEvent = function onBrowserEvent_0(event_0){
  $eventGetTypeInt(event_0.type) == $intern_19 && !!this.state && (this.element['__gwtLastUnhandledEvent'] = '' , undefined);
  $onBrowserEvent(this, event_0);
}
;
...
defineClass(39, 76, $intern_21, Label);
...
defineClass(115, 1, {223:1}, RootPanel$2);
...
defineClass(113, 47, $intern_22, RootPanel$DefaultRootPanel);
...
defineClass(127, 1, {224:1}, SimpleEventBus$2);
...
var Ljava_lang_Boolean_2_classLit = createForClass('java.lang', 'Boolean', 199);
...
var Ljava_lang_Double_2_classLit = createForClass('java.lang', 'Double', 200);
...
function fromCodePoint(codePoint){
  ...
  if (codePoint >= $intern_20) {
    hiSurrogate = 55296 + (codePoint - $intern_20 >> 10 & 1023) & $intern_9;
    loSurrogate = 56320 + (codePoint - $intern_20 & 1023) & $intern_9;
...
;
var Ljava_util_AbstractCollection_2_classLit = createForClass('java.util', 'AbstractCollection', 210);
...
;
var Ljava_util_AbstractMap_2_classLit = createForClass('java.util', 'AbstractMap', 209);
...
;
var Ljava_util_AbstractSet_2_classLit = createForClass('java.util', 'AbstractSet', 211);
...
defineClass(22, 211, $intern_23, AbstractHashMap$EntrySet);
...
;
var Ljava_util_AbstractList_2_classLit = createForClass('java.util', 'AbstractList', 213);
...
defineClass(70, 211, $intern_23, AbstractMap$1);
...
defineClass(34, 213, $intern_24, ArrayList);
...
defineClass(154, 213, $intern_24, Collections$EmptyList);
...
defineClass(158, 157, $intern_23, Collections$UnmodifiableMap$UnmodifiableEntrySet);
...
defineClass(179, 6, $intern_4, ConcurrentModificationException);
var Ljava_util_ConcurrentModificationException_2_classLit = createForClass('java.util', 'ConcurrentModificationException', 179);
...
defineClass(58, 211, {3:1, 37:1}, HashSet);
...
defineClass(164, 214, {9:1}, InternalStringMap$2);
...
var Ljava_util_Locale_2_classLit = createForClass('java.util', 'Locale', 201);
function Locale$1(){
}

defineClass(107, 201, {}, Locale$1);
...
var Ljava_util_logging_Level_2_classLit = createForClass('java.util.logging', 'Level', 212);
function Level$LevelAll(){
}

defineClass(138, 212, $intern_2, Level$LevelAll);
...
defineClass(139, 212, $intern_2, Level$LevelConfig);
...
defineClass(140, 212, $intern_2, Level$LevelFine);
...
defineClass(141, 212, $intern_2, Level$LevelFiner);
...
defineClass(142, 212, $intern_2, Level$LevelFinest);
...
defineClass(143, 212, $intern_2, Level$LevelInfo);
...
defineClass(144, 212, $intern_2, Level$LevelOff);
...
defineClass(145, 212, $intern_2, Level$LevelSevere);
...
defineClass(146, 212, $intern_2, Level$LevelWarning);
...
function $getHandlers(this$static){
  if (LOGGING_OFF) {
    return initUnidimensionalArray(Ljava_util_logging_Handler_2_classLit, $intern_25, 42, 0, 0, 1);
  }
  return castTo($toArray(this$static.handlers, initUnidimensionalArray(Ljava_util_logging_Handler_2_classLit, $intern_25, 42, this$static.handlers.array.length, 0, 1)), 186);
}
...
defineClass(219, 1, {});
var Ljavaemul_internal_ConsoleLogger_2_classLit = createForClass('javaemul.internal', 'ConsoleLogger', 219);
...
function $callThat(this$static){
  ...
  $put_1(parmsRequest.stringMap, 'addressOfOffice', 'Marxabo');
  $put_1(parmsRequest.stringMap, 'alias', 'Maxa');
...
function $fillFields(this$static, string){
  ...
  try {
    ...
    sLcl = $get(jsonObject, 'numberToCount').toString_0();
    ...
    sLcl = $get(jsonObject, 'occuredTime').toString_0();
...
function $onModuleLoad_1(this$static){
  ...
  platform.element.className = 'panel';
  raqamiTel = new Label;
...
function $startAnimation(this$static){
  ...
  this$static.animationChildandon = new CustomAnimation(this$static.childandon.element, this$static, true);
  $scrollTo(this$static.animationChildandon);
  this$static.animationXalqa = new CustomAnimation(this$static.xalqa.element, this$static, false);
...
function MainEntryPoint(){
  ...
  this.func = 'get_queue_number';
  this.url_0 = 'http://localhost:8000/' + this.func;
}
